...
import argparse
import sys
sys.path.append("./evaluation/test-suite-sql-eval")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gold', dest='gold', type=str, help="gold queries")
    parser.add_argument('--pred', dest='pred', type=str, help="predicted queries")
    parser.add_argument('--db', dest='db', type=str, default="./data/spider/database", help="the directory that contains all the databases and test suites")
    parser.add_argument('--table', dest='table', type=str, default="./data/spider/tables.json", help="the tables.json schema file")
    ...
    item = data[args.idx]
    db_id, gold_sql = item['db_id'], item['query']
    ...
    evaluate(gold_sql, pred_sql, args.db, args.etype, kmaps, args.plug_value,
